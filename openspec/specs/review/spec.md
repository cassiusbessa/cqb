...
Defines the `/cqb` Cursor ritual: gather a diff, run the quality gate, run review layers in parallel, triage, present in Portuguese to the operator, overlay consumer rules, and read the quality bundle without treating skip or unavailable as a pass.
